...
<div class="card">
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a href="#tabs-home-14" class="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab">Generan Settings</a>
            </li>
            <li class="nav-item" role="presentation">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-2" style="max-width:200px">
                                <img src="" alt="" class="img-thumbnail" id="logo-image-preview" data-ijabo-default-img="{{
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2" style="max-width: 100px;">
                                <img src="" id="favicon-image-preview" alt="" class="img-thumbnail" data-ijabo-default-img="{{\App\Models\Setting::find(1)->blog_favicon}}">
    ...
    <script>
        ...
        $('input[name="blog-favicon"]').ijaboViewer({
